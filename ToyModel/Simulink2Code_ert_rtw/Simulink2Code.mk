###########################################################################
## Makefile generated for component 'Simulink2Code'. 
## 
## Makefile     : Simulink2Code.mk
## Generated on : Wed Apr 09 13:29:15 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Simulink2Code
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Simulink2Code
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Simulink2Code_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Simulink2Code -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Simulink2Code_ert_rtw/Simulink2Code.cpp

MAIN_SRC = $(START_DIR)/Simulink2Code_ert_rtw/ert_main.cpp
...
%.o : $(START_DIR)/Simulink2Code_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Simulink2Code_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Simulink2Code_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Simulink2Code_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Simulink2Code_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Simulink2Code.o : $(START_DIR)/Simulink2Code_ert_rtw/Simulink2Code.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Simulink2Code_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
