###########################################################################
## Makefile generated for component 'leadCar'. 
## 
## Makefile     : leadCar.mk
## Generated on : Wed Jun 18 12:30:33 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/leadCar
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/leadCar
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/leadCar_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=leadCar -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/leadCar_ert_rtw/leadCar.cpp

MAIN_SRC = $(START_DIR)/leadCar_ert_rtw/ert_main.cpp
...
%.o : $(START_DIR)/leadCar_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/leadCar_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/leadCar_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/leadCar_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/leadCar_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/leadCar_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


leadCar.o : $(START_DIR)/leadCar_ert_rtw/leadCar.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
