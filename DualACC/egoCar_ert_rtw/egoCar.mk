###########################################################################
## Makefile generated for component 'egoCar'. 
## 
## Makefile     : egoCar.mk
## Generated on : Wed Jun 18 12:33:22 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/egoCar
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/egoCar
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/egoCar_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=egoCar -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/egoCar_ert_rtw/egoCar.cpp $(START_DIR)/egoCar_ert_rtw/egoCar_data.cpp $(START_DIR)/egoCar_ert_rtw/rtGetNaN.cpp $(START_DIR)/egoCar_ert_rtw/rt_nonfinite.cpp

MAIN_SRC = $(START_DIR)/egoCar_ert_rtw/ert_main.cpp
...
OBJS = egoCar.o egoCar_data.o rtGetNaN.o rt_nonfinite.o
...
%.o : $(START_DIR)/egoCar_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/egoCar_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/egoCar_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/egoCar_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
egoCar.o : $(START_DIR)/egoCar_ert_rtw/egoCar.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


egoCar_data.o : $(START_DIR)/egoCar_ert_rtw/egoCar_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/egoCar_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/egoCar_ert_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/egoCar_ert_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
