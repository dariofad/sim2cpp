...
## Generated on : Sun Jun 08 15:50:19 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mpcACCsystem
...
START_DIR                 = /Users/deyun/git/sim2cpp/AdaptiveCruiseControlExample
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mpcACCsystem
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/mpcACCsystem_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
SRCS = $(START_DIR)/mpcACCsystem_ert_rtw/mpcACCsystem.cpp $(START_DIR)/mpcACCsystem_ert_rtw/mpcACCsystem_data.cpp $(START_DIR)/mpcACCsystem_ert_rtw/rtGetNaN.cpp $(START_DIR)/mpcACCsystem_ert_rtw/rt_nonfinite.cpp

MAIN_SRC = $(START_DIR)/mpcACCsystem_ert_rtw/ert_main.cpp
...
OBJS = mpcACCsystem.o mpcACCsystem_data.o rtGetNaN.o rt_nonfinite.o
...
%.o : $(START_DIR)/mpcACCsystem_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/mpcACCsystem_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/mpcACCsystem_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/mpcACCsystem_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/mpcACCsystem_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/mpcACCsystem_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


mpcACCsystem.o : $(START_DIR)/mpcACCsystem_ert_rtw/mpcACCsystem.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


mpcACCsystem_data.o : $(START_DIR)/mpcACCsystem_ert_rtw/mpcACCsystem_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/mpcACCsystem_ert_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/mpcACCsystem_ert_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
